...
var ASM_CONSTS = {
  7835320: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7835375: ($0) => { performance.now = function() { return $0; }; },  
 7835423: ($0) => { performance.now = function() { return $0; }; },  
 7835471: () => { performance.now = Module['emscripten_get_now_backup']; }
};
